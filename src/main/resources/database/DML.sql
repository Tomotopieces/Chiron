...
VALUES(1, 1, '语文', '大学一年级', true, '很好', '2020-12-16', '语文课后作业', 'E://1.txt'),
      (1, 2, '语文', '大学一年级', false, null, null, '语文课后作业', 'E://11.txt'),
      (1, 3, '语文', '大学一年级', true, '还行', '2020-12-16', '语文课后作业', 'E://22.txt'),
      (2, 1, '数学', '大学一年级', true, '不错', '2020-12-17', '数学课后作业', 'E://1.txt'),
      (2, 2, '数学', '大学一年级', true, '一般', '2020-12-17', '数学课后作业', 'E://1.txt'),
      (2, 3, '数学', '大学一年级', false, null, null, '数学课后作业', 'E://22.txt'),
      (3, 1, '英语', '大学一年级', false, null, null, '英语课后作业', 'E://1.txt'),
      (3, 2, '英语', '大学一年级', true, '继续努力', '2020-12-18', '英语课后作业', 'E://11.txt'),
      (3, 3, '英语', '大学一年级', true, '加油', '2020-12-18', '英语课后作业', 'E://22.txt');
